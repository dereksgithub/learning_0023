...
-   Four resolutions: Remotely sensed data and applications will vary based on the four resolutions
    ...
    -   Temporal = the time it revisits (e.g. daily, every 7 days, on demand ✈️)
