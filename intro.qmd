...
<div class="image-container" style="display: grid; grid-template-columns: repeat(2,1fr); gap:15px;">

<div class="image-item"><img src="images/intro/personal_intro.png" height = 290 width= 320px alt="NDVI for Bristol"><p align="center" class="caption">GIS Crew and I (in the middle) Surveying Hu-Hang-Yong Highway in Zhejiang Province for Installing RSUs (Road Side Units)</p></div>

<div class="image-item"><img src="images/intro/cr_portable_01.png" height = 290 width= 220px alt="SAVI for Bristol"><p align="center" class="caption">My Hand-made Portable Air-Filtering System (HEPA-13 + 2 x turbo fans + Active charcoal Filter) Powered bn a Powerbank</p></div></div>
