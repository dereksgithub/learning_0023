...
In week 5, we had two sessions but mostly dedicated for group work planning and discussions. This week's discussion on the temperature and Urban Heat Island. There is no entry of learning diary required, however, we did have most of the practical session working on our group assessments.
...
3.  Other key points are that we agreed upon for this project is to develop the work covered in the pitch into Work-packs, perform SWOT analysis, design automated Data Pipelines, and adding a Gantt Chart.
