...
Aside from the NDVI, here are some other indicators that I have investigated and sumarized:
...
-   **ARVI (Atmospherically Resistant Vegetation Index)** is commonly employed to tackle regions of high atmospheric aerosol content. It was originally proposed for remote sensing of EOS MODIS sensor. [@kaufman1992atmospherically] The range for an ARVI is -1 to 1 where green vegetation generally falls between values of 0.20 to 0.80.
    ...
    -   According to ArcGIS: ["ARVI is a vegetation-based index that minimizes the effects of atmospheric scattering caused by rain, fog, dust, smoke, or air pollution."](https://www.arcgis.com/home/item.html?id=56a6db4cdd1c46988a1411d0365fd5f7){style="color:#7294D4;"}
...
These indicators, are sufficient only for basic analysis demands, to dderive more hidden relations, more modern techniques such as deep learning,[@ma2019deep] and Semi-supervised representation learning [@yan2020semi] can also be employed. As for the technical part for this week's practical, coding part is smooth, however the data collection and alignment do require a high level of dedication to get right at first run.
