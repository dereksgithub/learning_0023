...
This week we cover the Synthetic Aperture Radar (SAR) and application of SAR data. SAR employs radar to create images of the Earth's surface which makes it an active sensor.
